...
func (st *FileStorage) SaveURL(url, UID string) (string, error) {
...
func (st *FileStorage) GetURL(hash string) (string, error) {
...
func (st *FileStorage) GetUrlsByUID(uid string) ([]URL, error) {
	result := []URL{}
...
func (st *FileStorage) IsAlive() (bool, error) {
